...
1. Создан роут, который позволяет разлогиниться. Для этого в базе данные есть еще одна коллекция tokens , ключи в которой хранятся неделю.
...
2. Ограничение запросов пользователя реализовано на уровене nginx.
